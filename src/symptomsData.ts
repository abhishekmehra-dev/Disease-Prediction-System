...
// Shared local symptom matching and dynamic differential score calculation
export function fallbackLocalPredictor(activeSymptoms: string[]): { disease: string; differentials: { disease: string; probability: number }[] } {
